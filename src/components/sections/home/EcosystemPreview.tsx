            ...
            return (
              ...
              >
                <div className="relative group h-full">
                  <div className="glass-panel rounded-2xl p-8 h-full flex flex-col items-center justify-center text-center border border-[var(--gold)]/20 hover:border-[var(--gold)]/60 hover:shadow-[0_0_30px_rgba(212,175,55,0.2)] transition-all duration-300">
                    {/* Icon */}
