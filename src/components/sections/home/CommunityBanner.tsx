        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            >
              ...
              <Link to="/community">
                <button className="min-w-[160px] px-8 py-4 rounded-full border-2 border-[var(--gold)] text-[var(--gold)] font-semibold hover:bg-[var(--gold)] hover:text-[var(--bg-primary)] transition-all duration-300">
                  Join Community
                </button>
              </Link>
            </motion.div>
