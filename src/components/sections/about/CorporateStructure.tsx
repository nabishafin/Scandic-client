...
export function CorporateStructure() {
  ...
  return <section className="py-32 px-6 lg:px-12 bg-gradient-to-b from-transparent to-[var(--bg-secondary)]/30">
          ...
          <GlassPanel>
            ...
            <div className="relative mt-12">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {subsidiaries.map((sub, index) => <motion.div key={sub.name} initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                delay: index * 0.05
                    ...
                    {index < subsidiaries.length - 1 && <div className="hidden lg:block absolute top-1/2 left-full w-6 h-px bg-[var(--gold)]/20 -translate-y-1/2" />}
                  </motion.div>)}
              </div>
            </div>
          </GlassPanel>
