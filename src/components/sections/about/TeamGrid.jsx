...
export function TeamGrid() {
    ...
    return (
        <section className="py-32 px-6 lg:px-12" id="team">
                        ...
                        >
                            <div className="glass-panel rounded-2xl overflow-hidden">
                                ...
                                <div className="relative aspect-square overflow-hidden">
                                    ...
                                    <motion.div
                                        className="absolute inset-0 border-2 border-[var(--gold)]"
                                        initial={{ opacity: 0 }}
                                        ...
                                        {hoveredMember === index && (
                                            ...
                                            >
                                                ...
                                                <div className="flex space-x-3">
                                                    <a
                                                        href="#"
                                                        className="w-8 h-8 rounded-full border border-[var(--gold)] flex items-center justify-center text-[var(--gold)] hover:bg-[var(--gold)] hover:text-[var(--bg-primary)] transition-all duration-300"
                                                        aria-label="LinkedIn"
                                                    >
                                                        <Linkedin size={16} />
                                                    </a>
